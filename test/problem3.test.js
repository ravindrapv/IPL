...
} = require("../src/server/matches-won");
...
test("Calculates the number of matches won by each team per year correctly", () => {
  ...
  return matchesData.then((data) => {
    const result = calculateMatchesWonPerTeamPerYear(data);

    // Define the expected output based on your dataset
